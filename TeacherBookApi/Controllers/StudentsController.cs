...
namespace TeacherBookApi.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public StudentsController(TeacherBookContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Student>>> GetStudents()
        {
          if (_context.Students == null)
          {
            ...
            return await _context.Students.Include(x => x.Histories).Include(x => x.Journals).
                                             ToListAsync();
        }
        ...
        public async Task<ActionResult<Student>> PostStudent(Student student)
        {
          if (_context.Students == null)
          {
              return Problem("Entity set 'TeacherBookContext.Students'  is null.");
          }
